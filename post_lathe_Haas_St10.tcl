########################## TCL Event Handlers ##########################
#
#  post_lathe_Haas_St10.tcl - lathe
#
...
#
  ...
  set mom_sys_alt_unit_post_name                "post_lathe_Haas_St10__IN.pui"
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_cycle_ret_code(AUTO)              "94"
  set mom_sys_cycle_ret_code(MANUAL)            "95"
  ...
  set mom_sys_post_builder_version              "12.0.0"
...
#=============================================================
  ...
  MOM_output_literal "(Trabajo         :  $mom_operation_name)"
  MOM_output_literal "(Fecha           :  $mom_date)"
  MOM_output_literal "(No. de herram.  :  $mom_tool_number)"
  MOM_output_literal "(Nom. de herram. :  $mom_tool_name)"
}
...
proc PB_CMD_set_ref { } {
#=============================================================
# This command reads the Operator Message from the UI.
# The operator message can be set by double-clicking the
# program folder, 1234 by default. Enable the message and type
# in the team number. The only requirement is that the team
# number is the last digit in the message.

# Example of working formats:
# Team 7
# John from Team 7
# t7
...
# extract the last digit matched to team_number
regexp -all {[0-9]} $mom_operator_message team_number

# map team numbers to G54 to G59 codes
if { [info exists team_number] } {
    set gcode [expr ($team_number - 1) % 6 + 54]
} else {
    set gcode 54
    set team_number "N/A"
    MOM_set_seq_off
    MOM_output_literal "(Sin no. de equipo. Usando G54.)"
    MOM_output_literal "(Para asignar el no. de equipo, ir a )"
    MOM_output_literal "(Program Order View > doble click '1234' > activar)"
    MOM_output_literal "(ejemplo: 'peon equipo 4')"
    MOM_output_literal "( Inicio del programa )"
    MOM_set_seq_on
}

# print the code and the team number confirmation
MOM_output_literal "G$gcode (Equipo leido: $team_number)"
}
